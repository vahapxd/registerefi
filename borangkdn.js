...
Ceza işlemlerin <#952091286926667797> kanalını okuduğun varsayılarak uygulanır. ( <@&951955186019098694> )`)});
...
client.on("userUpdate", async function(oldUser, newUser) { 
    ...
    const embed = new Discord.MessageEmbed().setAuthor(member.displayName, member.user.avatarURL({ dynamic: true })).setColor('#ff0010').setTimestamp().setFooter('Rencia was here!');
...
client.login("OTUyMDk4NjMyODU1ODYzMjk2.YixE8w.pWL2htgn4D9938_l0ht_sr0ldVk")
